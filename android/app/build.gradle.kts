...
// Release signing from android/key.properties (gitignored). CI writes it from
// secrets; absent locally → falls back to debug signing.
...
android {
    ...
    buildTypes {
        release {
            // Real release key when key.properties exists (CI/local), else debug.
