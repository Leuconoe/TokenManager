...
const M: Record<Locale, Dict> = {
  ko: {
    ...
    syncSub: "Drive의 숨김 앱 폴더로 암호화된 보관함을 기기 간 동기화. 앱과 같은 파일을 공유합니다.",
    syncConnect: "Google Drive 연결",
    syncDisconnect: "연결 해제",
    syncConnected: "연결됨",
    syncRedirect: "리디렉션 URI (OAuth 클라이언트에 등록):",
    syncPassLabel: "동기화 패스프레이즈 (모든 기기 동일)",
    syncPassSave: "패스프레이즈 저장",
    syncNow: "지금 동기화",
    syncing: "동기화 중…",
    syncDone: "동기화됨 ({count})",
    syncFailed: "동기화 실패 — 패스프레이즈/연결 확인",
    syncPassMismatch: "동기화 패스프레이즈가 일치하지 않습니다 — 다른 기기와 같은 값을 입력하세요",
    syncNeedSetup: "먼저 Drive 연결 및 동기화 패스프레이즈를 설정하세요",
    syncNeedClientId: "OAuth 클라이언트 ID 미설정 (가이드 참고)",
    syncLast: "마지막 동기화: {time}",
    syncNever: "없음",
    debugLogTitle: "디버그 로그",
    debugRefresh: "새로고침",
    debugClear: "지우기",
    debugEmpty: "(로그 없음)",
    trashTitle: "휴지통",
    trashEmpty: "휴지통이 비어 있습니다",
    trashHint: "복원하거나 완전 삭제할 수 있습니다. 30일 지난 항목은 자동 정리됩니다.",
    trashRestore: "복원",
    trashPurge: "완전 삭제",
    trashPurgeAll: "휴지통 비우기",
    trashPurgeAllConfirm: "휴지통의 모든 항목을 완전 삭제할까요?",
    trashDeletedOn: "삭제일 {date}",
    sortExpiry: "만료일순",
    sortCreated: "생성일순",
    sortName: "이름순",
    sortSite: "사이트순",
    ...
    sortDesc: "내림차순",
    versionTitle: "버전",
    searchPlaceholder: "검색 (제목/사이트/노트)",
  ...
  en: {
    ...
    syncSub: "Sync the encrypted vault across devices via your Drive's hidden app folder. Shares the file with the app.",
    syncConnect: "Connect Google Drive",
    syncDisconnect: "Disconnect",
    syncConnected: "Connected",
    syncRedirect: "Redirect URI (register in the OAuth client):",
    syncPassLabel: "Sync passphrase (same on all devices)",
    syncPassSave: "Save passphrase",
    syncNow: "Sync now",
    syncing: "Syncing…",
    syncDone: "Synced ({count})",
    syncFailed: "Sync failed — check passphrase / connection",
    syncPassMismatch: "Sync passphrase doesn't match — use the same one as your other device",
    syncNeedSetup: "Connect Drive and set a sync passphrase first",
    syncNeedClientId: "OAuth client ID not set (see guide)",
    ...
    trashHint: "Restore or permanently delete. Items older than 30 days are cleared automatically.",
    trashRestore: "Restore",
    trashPurge: "Delete permanently",
    trashPurgeAll: "Empty trash",
    trashPurgeAllConfirm: "Permanently delete all items in the trash?",
    ...
    searchPlaceholder: "Search (title / site / note)",
  ...
  ja: {
    ...
    syncTitle: "Google Drive 同期",
    syncSub: "Drive の隠しアプリフォルダで暗号化保管庫を端末間同期。アプリと同じファイルを共有。",
    syncConnect: "Google Drive を接続",
    syncDisconnect: "切断",
    syncConnected: "接続済み",
    syncRedirect: "リダイレクト URI（OAuth クライアントに登録）:",
    syncPassLabel: "同期パスフレーズ（全端末で同一）",
    syncPassSave: "パスフレーズを保存",
    syncNow: "今すぐ同期",
    syncing: "同期中…",
    syncDone: "同期しました ({count})",
    syncFailed: "同期に失敗 — パスフレーズ/接続を確認",
    syncPassMismatch: "同期パスフレーズが一致しません — 他の端末と同じ値を入力してください",
    syncNeedSetup: "先に Drive 接続と同期パスフレーズを設定してください",
    syncNeedClientId: "OAuth クライアント ID 未設定（ガイド参照）",
    syncLast: "最終同期: {time}",
    syncNever: "なし",
    debugLogTitle: "デバッグログ",
    debugRefresh: "更新",
    debugClear: "クリア",
    debugEmpty: "(ログなし)",
    trashTitle: "ゴミ箱",
    trashEmpty: "ゴミ箱は空です",
    trashHint: "復元または完全削除できます。30日経過した項目は自動的に削除されます。",
    trashRestore: "復元",
    trashPurge: "完全に削除",
    trashPurgeAll: "ゴミ箱を空にする",
    trashPurgeAllConfirm: "ゴミ箱のすべての項目を完全に削除しますか？",
    trashDeletedOn: "削除日 {date}",
    sortExpiry: "期限順",
    sortCreated: "作成日順",
    sortName: "名前順",
    sortSite: "サイト順",
    ...
    sortDesc: "降順",
    versionTitle: "バージョン",
    searchPlaceholder: "検索（名前/サイト/メモ）",
  ...
  zh: {
    ...
    syncSub: "通过 Drive 的隐藏应用文件夹在设备间同步加密保管库。与应用共享同一文件。",
    syncConnect: "连接 Google Drive",
    syncDisconnect: "断开连接",
    syncConnected: "已连接",
    syncRedirect: "重定向 URI（注册到 OAuth 客户端）：",
    syncPassLabel: "同步口令（所有设备一致）",
    syncPassSave: "保存口令",
    syncNow: "立即同步",
    syncing: "同步中…",
    syncDone: "已同步 ({count})",
    syncFailed: "同步失败 — 请检查口令/连接",
    syncPassMismatch: "同步口令不匹配 — 请使用与其他设备相同的口令",
    syncNeedSetup: "请先连接 Drive 并设置同步口令",
    syncNeedClientId: "未设置 OAuth 客户端 ID（见指南）",
    syncLast: "上次同步：{time}",
    syncNever: "从未",
    debugLogTitle: "调试日志",
    debugRefresh: "刷新",
    ...
    trashTitle: "回收站",
    trashEmpty: "回收站为空",
    trashHint: "可恢复或永久删除。超过30天的项目会自动清理。",
    trashRestore: "恢复",
    trashPurge: "永久删除",
    trashPurgeAll: "清空回收站",
    trashPurgeAllConfirm: "永久删除回收站中的所有项目？",
    trashDeletedOn: "删除于 {date}",
    sortExpiry: "按到期",
    sortCreated: "按创建",
    sortName: "按名称",
    sortSite: "按站点",
  ...
  zh_Hant: {
    ...
    syncTitle: "Google Drive 同步",
    syncSub: "透過 Drive 的隱藏應用程式資料夾在裝置間同步加密保管庫。與應用程式共用同一檔案。",
    syncConnect: "連接 Google Drive",
    syncDisconnect: "中斷連線",
    syncConnected: "已連線",
    syncRedirect: "重新導向 URI（註冊到 OAuth 用戶端）：",
    syncPassLabel: "同步通關密語（所有裝置一致）",
    syncPassSave: "儲存通關密語",
    syncNow: "立即同步",
    syncing: "同步中…",
    syncDone: "已同步 ({count})",
    syncFailed: "同步失敗 — 請檢查通關密語/連線",
    syncPassMismatch: "同步通關密語不一致 — 請使用與其他裝置相同的值",
    syncNeedSetup: "請先連接 Drive 並設定同步通關密語",
    syncNeedClientId: "未設定 OAuth 用戶端 ID（見指南）",
    syncLast: "上次同步：{time}",
    syncNever: "從未",
    debugLogTitle: "偵錯記錄",
    debugRefresh: "重新整理",
    ...
    trashTitle: "回收筒",
    trashEmpty: "回收筒是空的",
    trashHint: "可還原或永久刪除。超過30天的項目會自動清理。",
    trashRestore: "還原",
    trashPurge: "永久刪除",
    trashPurgeAll: "清空回收筒",
    trashPurgeAllConfirm: "永久刪除回收筒中的所有項目？",
    trashDeletedOn: "刪除於 {date}",
    sortExpiry: "依到期",
    sortCreated: "依建立",
    sortName: "依名稱",
    sortSite: "依網站",
  ...
  es: {
    ...
    syncTitle: "Sincronización con Google Drive",
    syncSub: "Sincroniza la bóveda cifrada entre dispositivos mediante la carpeta oculta de tu Drive. Comparte el archivo con la app.",
    syncConnect: "Conectar Google Drive",
    syncDisconnect: "Desconectar",
    syncConnected: "Conectado",
    syncRedirect: "URI de redirección (regístrala en el cliente OAuth):",
    syncPassLabel: "Frase de sincronización (igual en todos los dispositivos)",
    syncPassSave: "Guardar frase",
    syncNow: "Sincronizar ahora",
    syncing: "Sincronizando…",
    syncDone: "Sincronizado ({count})",
    syncFailed: "Error de sincronización — revisa frase/conexión",
    syncPassMismatch: "La frase de sincronización no coincide — usa la misma que en tu otro dispositivo",
    syncNeedSetup: "Conecta Drive y define una frase de sincronización primero",
    syncNeedClientId: "ID de cliente OAuth no configurado (ver guía)",
    syncLast: "Última sincronización: {time}",
    syncNever: "nunca",
    debugLogTitle: "Registro de depuración",
    debugRefresh: "Actualizar",
    debugClear: "Borrar",
    debugEmpty: "(sin registros)",
    trashTitle: "Papelera",
    trashEmpty: "La papelera está vacía",
    trashHint: "Restaura o elimina definitivamente. Los elementos de más de 30 días se borran automáticamente.",
    trashRestore: "Restaurar",
    trashPurge: "Eliminar definitivamente",
    trashPurgeAll: "Vaciar papelera",
    trashPurgeAllConfirm: "¿Eliminar definitivamente todos los elementos de la papelera?",
    trashDeletedOn: "Eliminado el {date}",
    sortExpiry: "Por caducidad",
    sortCreated: "Por creación",
    sortName: "Por nombre",
    sortSite: "Por sitio",
    sortAsc: "Ascendente",
    sortDesc: "Descendente",
    versionTitle: "Versión",
    searchPlaceholder: "Buscar (nombre / sitio / nota)",
  ...
  fr: {
    ...
    syncTitle: "Synchronisation Google Drive",
    syncSub: "Synchronise le coffre chiffré entre appareils via le dossier d'app caché de votre Drive. Partage le fichier avec l'app.",
    syncConnect: "Connecter Google Drive",
    syncDisconnect: "Déconnecter",
    syncConnected: "Connecté",
    syncRedirect: "URI de redirection (à enregistrer dans le client OAuth) :",
    syncPassLabel: "Phrase de synchronisation (identique sur tous les appareils)",
    syncPassSave: "Enregistrer la phrase",
    syncNow: "Synchroniser maintenant",
    syncing: "Synchronisation…",
    syncDone: "Synchronisé ({count})",
    syncFailed: "Échec de synchro — vérifiez la phrase/connexion",
    syncPassMismatch: "La phrase de synchro ne correspond pas — utilisez la même que sur l'autre appareil",
    syncNeedSetup: "Connectez Drive et définissez une phrase de synchro d'abord",
    syncNeedClientId: "ID client OAuth non défini (voir le guide)",
    syncLast: "Dernière synchro : {time}",
    syncNever: "jamais",
    debugLogTitle: "Journal de débogage",
    debugRefresh: "Actualiser",
    debugClear: "Effacer",
    debugEmpty: "(aucun journal)",
    trashTitle: "Corbeille",
    trashEmpty: "La corbeille est vide",
    trashHint: "Restaurez ou supprimez définitivement. Les éléments de plus de 30 jours sont effacés automatiquement.",
    trashRestore: "Restaurer",
    trashPurge: "Supprimer définitivement",
    trashPurgeAll: "Vider la corbeille",
    trashPurgeAllConfirm: "Supprimer définitivement tous les éléments de la corbeille ?",
    trashDeletedOn: "Supprimé le {date}",
    sortExpiry: "Par expiration",
    sortCreated: "Par création",
    sortName: "Par nom",
    sortSite: "Par site",
    sortAsc: "Croissant",
    sortDesc: "Décroissant",
    versionTitle: "Version",
    searchPlaceholder: "Rechercher (nom / site / note)",
